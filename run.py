...
def get_sales_data():
    ...
    by commas. The loop will repeadetely request data, until it is valid.
    """
    while True:
...
def validate_data(values):
    ...
    Raise ValueError if strings cannot be convert into int,
...
def update_sales_worksheet(data):
    ...
    sales_workseet = SHEET.worksheet("sales")
    sales_workseet.append_row(data)
...
def update_surplus_worksheet(data):
    ...
    surplus_workseet = SHEET.worksheet("surplus")
    surplus_workseet.append_row(data)
